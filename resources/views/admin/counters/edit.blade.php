...
@section('page-title', 'Edit Loket')

@section('content')
<div class="max-w-xl">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.counters.update', $counter) }}" class="space-y-4">
            @csrf @method('PUT')
            <div>
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Layanan yang Dilayani</label>
