        ...
        <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-4">
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                    Prefix <span class="text-gray-400 font-normal">(maks 5 karakter, contoh: A, KTP)</span>
                </label>
                <input type="text" name="prefix" value="{{ old('prefix') }}" maxlength="5"
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5">{{ old('description') }}</textarea>
            </div>
